...
function EditProfile() {
    ...
    const updateUser = async (updateEvent: { preventDefault: () => void; }) => {
    ...
    const updateWithNew = async () => {
        try {
            ...
            const res = await fetch(`${backendBaseURL}/api/users/updateUser`, req).then((response) => response.json());
              ...
              >
                ...
                <Form onSubmit={updateUser}>
                  <Row>
                    <Col>
                      <Form.Group
                        title={"inputOldPassword"}
                        controlId={"formBasicOldPassword"}
                        style={{ maxWidth: "400px", paddingBottom: "8px" }}
                      >
